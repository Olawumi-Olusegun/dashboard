...
export default function HeaderNav({}: Props) {
  ...
  return (
...

    {
        ...
        <label htmlFor='search' className=' hidden lg:flex  ml-auto bg-white border rounded-full px-2 items-center gap-x-2 cursor-pointer  focus:outline-none focus:border-blue-500 focus:shadow-outline-blue '>
            <img src="images/search.png" alt="search" className='h-4 w-4 object-contain' />
            <input type="text" id='search' name='search' placeholder='Search...' className='placeholder:text-[#A3A3A3] bg-transparent focus:outline-none rounded-full w-full lg:w-auto p-3 placeholder:text-sm py-[0.5rem]  ' />
        </label>
